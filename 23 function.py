...
##Emil Refsnes
###my_function("Emil")#you have to call the function with 2 arguments, not more, and not less. 
'''
...
def my_function(*kids):  ##如果你不曉得會有幾個argument,在argument前面打*
    print("The youngest child is " + kids[2])

my_function("Emil", "Tobias", "Linus")
##The youngest child is Linus
def my_function2(*kids):  ##如果你不曉得會有幾個argument,在argument前面打*
