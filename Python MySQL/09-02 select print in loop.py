...
try:
    ...
    cursor.execute(sql_select_Query)#object cursor的執行，去執行select *，去執行select *
...
　　#Once all record fetched successfully, 
    #we closed the MySQL Cursor object using a cursor.close() and 
    # MySQL database connection using the connection.close().
