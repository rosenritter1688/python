from tkinter import Listbox,END,Button,ANCHOR,Label,Frame,Scrollbar,VERTICAL,RIGHT,Y,Tk,EXTENDED
import tkinter as tk
root = tk.Tk()
root.geometry("600x640")
root.config(bg="#353130")
#! selcet mode CHECK LINE 20   21
#! extended is user can control list box by keyboard, is like MULTIPLE but user Need to use SHIFT key , CTRL key for selecting multiple options
...
my_listbox = Listbox(my_frame, width=50, bg="#353130",fg="white", yscrollcommand=scroll_bar_4_my_listbox.set, selectmode = EXTENDED)  #?yscrollcommand -> is for horizontal scrollbar
